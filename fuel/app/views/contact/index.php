...
<div class="form-group">
    <label for="form_name" class="col-sm-2 control-label">名前</label>
    <div class="col-sm-8">
      <?php echo Form::input('name', Auth::get_screen_name(), array('class' => 'form-control'));?>
  ...
  <div class="form-group">
    ...
    <div class="col-sm-8">
      <?php echo Form::input('email',Auth::get_email(),array('class' => 'form-control','placeholder' => 'mail@example.com'));?>
...
<div class="form-group">
  ...
  <div class="form-group">
    <div class="col-sm-offset-2 col-sm-8 text-center">
      <?php echo Form::submit('submit', '内容確認', array('class' => 'btn btn-success btn-addcss'));?>
